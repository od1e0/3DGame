    ...
    public class FireLightScript : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (seed != 0)
            {
                ...
                float x = Mathf.PerlinNoise(seed + Time.time * 1, seed + Time.time * 1) - 0.5f;
                float y = Mathf.PerlinNoise(seed + Time.time * 1, seed + Time.time * 1) - 0.5f;
                float z = Mathf.PerlinNoise(seed + Time.time * 1, seed + Time.time * 1) - 0.5f;
